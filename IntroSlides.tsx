...
const INTRO_SLIDES: IntroSlide[] = [
  {
    ...
    text: 'הם הגיעו ללא אזהרה, צי צללים שכיסה את השמש. כדור הארץ נותר חרב תחת עלטה נצחית.'
  },
  {
    image: '/intro/slide2.png',
    text: 'במעמקי האדמה, המדענים גילו את התקווה האחרונה: תדר קולי ייחודי המסוגל לחדור את השריון שלהם.'
  },
  {
    image: '/intro/slide3.png',
    text: 'זהו הכלי שלך: מטוס קרב שהוסב לנשק סוני עוצמתי. במקום פצצות – הוא חמוש במערכות שידור קטלניות.'
  },
  {
    image: '/intro/slide4.png',
    text: 'היכנס לתא הטייס. המשימה: זהה את מילת הקוד באנגלית, כוון לתרגום המדויק בעברית, והשמד את המטרות.'
  },
  {
    image: '/intro/slide5.png',
    text: 'השמיים קוראים לך. תמרן בין מטחי האויב, שחרר את "גל ההדף" הכחול, והביס את ספינת האם. המראה!'
  }
];
